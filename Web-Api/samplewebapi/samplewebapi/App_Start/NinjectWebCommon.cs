...
namespace samplewebapi.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        {
          //  kernel.Bind<IEMPdetails>().To<EmpDetailes>();
           // kernel.Bind<iProject>().To<Empdetails>();
            kernel.Bind<IReservation>().To<ResDetailes>();
            kernel.Bind<IDistributorsProject>().To<projectdetails>();
        }
